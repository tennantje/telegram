...
import { SendMessageCommand, SendMarkdownMessageCommand } from "./commands";
...
export class TelegramClient {
  ...
  public async send(command: SendMessageCommand | SendMarkdownMessageCommand): Promise<SendMessageOutput> {
